    ...
    return Container(
        child: SingleChildScrollView(
            ...
            Column(
              ...
              children: <Widget>[
          widget.record.species==Constants.UNKNOWN_BAT?SizedBox():
          Column(
          children: <Widget>[
                Image.asset(
                ...
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 10,),
                    Expanded(child:
                    Text(widget.record.species, style: TextStyle(color: CustomColors.primaryColor, fontSize: 18),)),
                  ],
                ),
                SizedBox(height: 20,),
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 10,),
                    Expanded(child:
                    Text(widget.record.individuals, style: TextStyle(color: CustomColors.primaryColor, fontSize: 18),)),
                  ],
                ),
                SizedBox(height: 20,),
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 10,),
                    Expanded(child:
                    Text(widget.record.placeAddress, style: TextStyle(color: CustomColors.primaryColor, fontSize: 18),)),
                  ],
                ),
                SizedBox(height: 20,),
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 10,),
                    Expanded(child:
                    Text(widget.record.placeLatitude, style: TextStyle(color: CustomColors.primaryColor, fontSize: 18),)),
                  ],
                ),
                SizedBox(height: 20,),
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 10,),
                    Expanded(child:
                    Text(widget.record.placeLongitude, style: TextStyle(color: CustomColors.primaryColor, fontSize: 18),)),
                  ],
                ),
                SizedBox(height: 20,),
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 10,),
                    Expanded(child:
                    Text(widget.record.comments, style: TextStyle(color: CustomColors.primaryColor, fontSize: 18),)),
                  ],
                ),
                SizedBox(height: 10,),
