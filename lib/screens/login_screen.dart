...
class _LoginScreenState extends State<LoginScreen> {
          ...
          if (_formKey.currentState!.validate()) {
            ...
            signIn(emailController.text, passwordController.text)
              ...
              if (error.code == "ERROR_USER_NOT_FOUND") {
                Utils.showSnackBar(context, "Unable to find user. Please register.");
                // setState(() {
                ...
                // });
                Utils.showSnackBar(context, "There was an error logging in. Please try again later.");
              }
                }
                  );
          }
  ...
  void getDetails(User user) async {
      ...
      FirebaseFirestore.instance.collection('users').doc(user.uid)
          ...
          .listen((userData) {
        try {
        UserItem userItem = UserItem.fromMap(userData.data() as Map<String, dynamic>);
