...
import 'package:batsexplorer/styles/records_style.dart';
    ...
    return MaterialApp(
      ...
      home: Scaffold(
                      ...
                      FlatButton(
                        ...
                        onPressed: (){
                            ...
                            AppState.logout().then((value) {
                              Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: MainScreen(2)));
                            });
                        },
                      ),
                    ),
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: (){
            Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft, child: AddRecordScreen()));
          },
        ),
      ),
    );
      ...
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) => RecordsStyle(
